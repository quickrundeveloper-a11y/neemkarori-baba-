        ...
        <article className="space-y-16 font-serif text-lg md:text-xl leading-relaxed text-gray-300">
          ...
          <section className="animate-fade-in-up delay-100">
            <p className="mb-6 first-letter:text-5xl first-letter:font-bold first-letter:text-[#cf1f1f] first-letter:mr-3 first-letter:float-left">
              Neeb Karori Baba, also known as Maharaj-ji, was a famous Hindu saint and spiritual teacher who is widely respected across India and the world. He is known for his simple lifestyle, miracles, and teachings based on love, devotion, and service to humanity. Millions of devotees believe he was a divine soul who dedicated his life to helping people find peace and faith in God.
            </p>
          </section>
          ...
          <section className="animate-fade-in-up delay-200 grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="mb-6">
                Neeb Karori Baba was born around 1900 in a small village named Akbarpur in Uttar Pradesh, India. His birth name was Lakshmi Narayan Sharma. From childhood, he showed signs of deep spiritual interest. Although he lived a normal family life for some time and was married according to social customs, he later left home to follow a spiritual path.
              </p>
              <p>
                He traveled across India as a wandering saint and spent many years meditating and guiding people. During his spiritual journey, he became known as Neeb Karori Baba after he stayed near a village called Neeb Karori.
              </p>
            </div>
            <div className="relative aspect-[3/4] rounded-lg overflow-hidden shadow-xl transform rotate-2 hover:rotate-0 transition-transform duration-500">
               <img 
                src="/nkb5.jpg" 
                alt="Neeb Karori Baba Early Life" 
                className="w-full h-full object-cover"
              />
            </div>
          </section>
          ...
          <section className="animate-fade-in-up delay-300">
            ...
            <div className="bg-[#222] p-8 rounded-lg border-l-4 border-[#cf1f1f] mb-8">
              <p className="mb-6 italic text-white/90">
                Neeb Karori Baba taught very simple but powerful spiritual messages. His teachings focused mainly on:
              </p>
          ...
          <section className="animate-fade-in-up delay-400">
            ...
            <p className="mb-6">
              Many devotees believe that Neeb Karori Baba performed several miracles. People shared stories about how he helped them during difficult times, cured illnesses, and solved life problems. His followers believed he had supernatural spiritual powers and divine knowledge.
            </p>
            <p>
          ...
          <section className="animate-fade-in-up delay-500">
            ...
            <p className="mb-6">
              Neeb Karori Baba established several temples and ashrams across India. One of the most famous places connected to him is Kainchi Dham, located in Uttarakhand. This ashram attracts thousands of devotees every year.
            </p>
            <p>
          ...
          <section className="animate-fade-in-up delay-500 pb-20">
            ...
            <p className="mb-6">
              Neeb Karori Baba’s teachings reached international followers as well. Many famous personalities visited him and shared his spiritual wisdom with the world. His message of love, devotion, and service continues to inspire people across different cultures and religions.
            </p>
          </section>
          ...
          <section className="animate-fade-in-up delay-500">
            ...
            <p className="mb-6">
              Despite having thousands of followers, Neeb Karori Baba lived a very simple life. He usually wore a blanket and lived like an ordinary saint. He never wanted fame or wealth and always focused on helping people spiritually and emotionally.
            </p>
            <p>
          ...
          <section className="animate-fade-in-up delay-500">
            ...
            <p className="mb-6">
              Neeb Karori Baba left his physical body in 1973, but his teachings and spiritual presence continue to inspire millions. His temples and ashrams are still active, and devotees believe that his blessings continue to guide them.
            </p>
            <p>
