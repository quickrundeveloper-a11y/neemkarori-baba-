...
export default function Home() {
  ...
  return (
    <div ref={wrapper} className="bg-[#1a1a1a] min-h-screen w-full text-white font-serif selection:bg-red-900 selection:text-white overflow-x-hidden">
      ...
      <main
        ref={mainRef}
        className="h-screen w-full relative flex flex-col items-center justify-center overflow-x-hidden md:overflow-visible"
      >
        {/* Header */}
        <Header />
        ...
        <div className="relative z-10 flex flex-col items-center text-center w-full mt-0 md:mt-[-5vh]">
          ...
          {/* Numbers & Dash */}
          <div className="flex text-[18vw] md:text-[20vw] leading-[0.8] text-white font-serif items-center justify-center whitespace-nowrap mix-blend-normal z-10 w-full font-light notranslate px-[2vw]">
            <div className="w-1/2 flex justify-end">
              <div className="relative flex n-1915 origin-right">
                <span className="absolute top-[1vw] left-1/2 -translate-x-1/2 text-[3vw] md:text-[2vw] font-sans uppercase tracking-widest">BIRTH</span>
            ...
            <div className="w-1/2 flex justify-start">
              <div className="relative flex n-1917 origin-left">
                <span className="absolute top-[1vw] left-1/2 -translate-x-1/2 text-[3vw] md:text-[2vw] font-sans uppercase tracking-widest">Death</span>
                <span className="char-1 inline-block relative">1</span>
                <span className="char-2 inline-block relative">9</span>
